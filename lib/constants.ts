...
export const CHECKLIST_SECTIONS: ChecklistSection = {
  "General Wound Information": [
    ...
    { name: "culture_date", label: "Most recent culture date", type: "date" },
    {
      ...
      label: "If the infection is confirmed",
      type: "yn",
    },
    {
      name: "rx_iv_date",
    ...
    },
    {
      ...
      label: "If ABI ABNORMAL, the patient is referred to",
      type: "text",
    },
  ...
  "Venous Stasis Ulcers (VSUs)": [
    ...
    },
    {
      ...
      label: "If venous insufficiency is present, the patient is referred to",
      type: "text",
    },
    {
      name: "vascular_assessment_results",
      label: "Results of vascular assessment (e.g., ABI, toe pressure)",
      type: "text",
    },
    ...
    },
    {
      ...
      label: "Provision of wound environment to promote healing",
      type: "yn",
    },
  ],
  "Other Wound Types": [
    ...
    },
    {
      name: "xray_bony_area",
      label:
        "If there is a wound in the bony prominence area, an x-ray is taken",
      type: "yn_na",
    },
  ...
  "Additional Notes": [
    ...
    { name: "general_notes", label: "Other Notes", type: "text" },
  ],
};
